...
export const analyzeContent = async (
  ...
  return customFetch<AnalyzeResponse>(getAnalyzeContentUrl(), {
    ...options,
    method: "POST",
...
export const optimizeContent = async (
  ...
  return customFetch<OptimizeResponse>(getOptimizeContentUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export type OptimizeContentMutationError = ErrorType<ErrorResponse>;
